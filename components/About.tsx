    ...
    return (
        <section className="about bg-[#0F1141] text-center py-14 ">
            <div className='w-11/12 md:w-3/5 m-auto'>
                ...
                <p className="about-para text-2xl md:text-4xl font-bold text-white p-14">
            ...
            <div className="block md:flex w-3/4 m-auto justify-center items-center gap-10 py-10">
                <div className="flex flex-col text-center justify-between items-center py-6 md:py-0">
                    ...
                    <h2 className="font-bold text-xl text-[#A777ED]">Who are we</h2>
                ...
                <div className="flex flex-col text-center justify-between items-center py-6 md:py-0">
                    ...
                    <h2 className="font-bold text-xl text-[#A777ED]">What we do</h2>
                ...
                <div className="flex flex-col text-center justify-between items-center py-6 md:py-0">
                    ...
                    <h2 className="font-bold text-xl text-[#A777ED]">What we believe</h2>
